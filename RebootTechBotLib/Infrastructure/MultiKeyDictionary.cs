...
namespace RebootTechBotLib.Infrastructure
{
    ...
    {
        public MultiKeyDictionary():base()
        {

        }
        public MultiKeyDictionary(IDictionary<K1, Dictionary<K2, V>> dictionary) : base(dictionary)
        {
            //Dictionary<K1, Dictionary<K2, V>> dict = new Dictionary<K1, Dictionary<K2, V>>();
